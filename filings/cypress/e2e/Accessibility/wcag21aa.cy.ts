...
describe.skip('Accessibility Tests', () => {
    it("Login Page", { defaultCommandTimeout: 15000 }, () => {
        cy.visit("https://dev.azavargovapps.com/login");
        cy.checkAccessibility(null, customAccessibilityOptions);
    });
    it("AGS Filing List Page", { defaultCommandTimeout: 15000 }, () => {
        cy.login({ accountType: "ags" });
        agsFilingGrid.init();
        cy.checkAccessibility(null, customAccessibilityOptions);
    });
    it("Municipal Filing List Page", { defaultCommandTimeout: 15000 }, () => {
        cy.login({ accountType: "municipal" });
        municipalFilingGrid.init();
        cy.checkAccessibility(null, customAccessibilityOptions);
    });
    it("Taxpayer Filing List Page", { defaultCommandTimeout: 15000 }, () => {
        cy.login({ accountType: "taxpayer" });
        taxpayerFilingGrid.init();
        cy.checkAccessibility(null, customAccessibilityOptions);
    });
    it('Municipal Edit Page', { defaultCommandTimeout: 15000 }, () => {
        cy.login({ accountType: "ags" });
        municipalityGrid.init();
        municipalityGrid.selectMunicipality("City of Arrakis");
        cy.checkAccessibility(null, customAccessibilityOptions);
    });
    it('Taxpayer Submit Form Page', { defaultCommandTimeout: 15000 }, () => {
        cy.login({ accountType: "taxpayer" });
        filing.goToSubmitFormsTab();
        filing.selectGovernment("City of Arrakis");
        cy.checkAccessibility(null, customAccessibilityOptions);
    });
    it("Taxpayer Submit Form Modal Flow", () => {
        cy.login({ accountType: "taxpayer" });
        filing.goToSubmitFormsTab();
        filing.selectGovernment("City of Arrakis");
    ...
    it("Taxpayer Submit Form Flow - Basic Information Step", () => {
        cy.login({ accountType: "taxpayer" });
        filing.goToSubmitFormsTab();
        filing.selectGovernment("City of Arrakis");
        filing.selectForm("Food and Beverage");
    ...
    it("Taxpayer Submit Form Flow - Tax Information Step", () => {
        cy.login({ accountType: "taxpayer" });
        filing.goToSubmitFormsTab();
        filing.selectGovernment("City of Arrakis");
        filing.selectForm("Food and Beverage");
    ...
    it("Taxpayer Submit Form Flow - Preparer Information Step", () => {
        cy.login({ accountType: "taxpayer" });
        filing.goToSubmitFormsTab();
        filing.selectGovernment("City of Arrakis");
        filing.selectForm("Food and Beverage");
    ...
    it("Taxpayer Submit Form Flow - Payment Page", () => {
        cy.login({ accountType: "taxpayer" });
        filing.goToSubmitFormsTab();
        filing.selectGovernment("City of Arrakis");
        filing.selectForm("Food and Beverage");
    ...
    it("Taxpayer Submit Form Flow - Application Confirmation Page", () => {
        cy.login({ accountType: "taxpayer" });
        filing.goToSubmitFormsTab();
        filing.selectGovernment("City of Arrakis");
        filing.selectForm("Food and Beverage");
    ...
    it("Municipal Export Full Filing Data Modal", () => {
    ...
    it("Municipal Specific Filing Page", () => {
        cy.login({ accountType: "municipal", accountIndex: 2 });
        municipalFilingGrid.init();
    ...
    it("Municipal Approval Page", () => {
        cy.login({ accountType: "municipal" });
        govApprovalGrid.init();
        cy.checkAccessibility(null, customAccessibilityOptions);
    });
    it("Municipal Approval Page - Message Modal", () => {
    ...
    it("Municipal Approval Review Page", () => {
