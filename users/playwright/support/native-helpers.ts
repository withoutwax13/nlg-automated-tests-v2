...
import { login as runtimeLogin, waitForLoading as runtimeWaitForLoading } from "./runtime";
export * from "./runtime";
...
export const getBaseUrl = () =>
  `https://${process.env.environment || process.env.ENVIRONMENT || "dev"}.azavargovapps.com`;
