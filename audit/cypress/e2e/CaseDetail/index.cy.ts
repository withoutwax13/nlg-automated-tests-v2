...
describe("Case Detail Scenarios", () => {
  it("As a user, I should be able to see that the column data in /cases grid are similar to the data in the /cases/{id}/info page", () => {
    cy.login();
