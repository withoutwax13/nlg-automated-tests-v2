...
describe("Data Grid Scenarios", () => {
  it("As a user, I should be able to view the data grid", () => {
    const columnHeaders = [
      "Case Name",
      "Government",
      "Case Type",
  ...
  it("As a user, I should be able to search the data grid", () => {
    const searchItems = [
      "dwight",
      "creve",
      "sales tax",
  ...
  sortTests.forEach(({ description, columnIndex }) => {
    it(`As a user, I should be able to sort the data grid by ${description}`, () => {
  ...
  it("As a user, I should see different colors on each status data", () => {
    const status = [
