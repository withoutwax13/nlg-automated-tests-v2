...
describe("If user opted for not an agency registering in behalf of the customer, the corresponding fields and labels must be visible on the Applicant info step", () => {
  it("Initiating test", () => {
