...
describe("When the business is linked and the application is approved, the current registration will be deleted, and a new one will be created with the linked business info.", () => {
  beforeEach(() => {
