...
describe.skip("As an AGS User, If I delete a business record associated to an ACTIVE Registration record, the Registration Status of the said registration record should be deleted.", () => {
  it("Initiating test", () => {
