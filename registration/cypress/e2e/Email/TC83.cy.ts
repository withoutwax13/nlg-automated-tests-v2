...
describe.skip("After submitting an application without making a payment, taxpayer user must receive an email with subject, content, and HTML structure similar to the editable template in the workflow.'", () => {
  it("Initiating test", () => {
