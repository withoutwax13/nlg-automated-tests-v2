...
describe("As a gov/AGS user, application records with not funded Payment Status in the filing list of credit card payment should be visible in the application list", () => {
  it("Initiating test", () => {
