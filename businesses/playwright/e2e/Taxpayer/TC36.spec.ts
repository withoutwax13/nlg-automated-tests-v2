...
test.describe("As a taxpayer, I should only have details and delete as options in my action button column", () => {
  test("As a taxpayer, I should only have details and delete as options in my action button column", { tag: ["@slot-01", "@taxpayer", "@business-active"] }, async ({ page, resourceSlot }) => {
