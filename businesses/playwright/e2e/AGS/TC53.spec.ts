...
test.describe("As a user, when the business is not active, I should not be able to update form submission requirements in the business details page", () => {
  test("As a user, when the business is not active, I should not be able to update form submission requirements in the business details page", { tag: ["@slot-03", "@ags", "@business-inactive"] }, async ({ page, resourceSlot }) => {
